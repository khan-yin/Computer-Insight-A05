...
"""
RECORD_PHOTO_ROOT = r"..\\..\\A051\\templates\\static\\image\\photo\\records\\"

class MysqlOperator(object):
    def __init__(self, ip='localhost', user='root', password='root', db='A05'):
    ...
    def insertRecord(self, wear_hat_confidence, most_close_worker_id,datetime,name,photo):
        ...
        path = RECORD_PHOTO_ROOT + filename
        #print(os.listdir("./"))
